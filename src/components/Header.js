  ...
  return (
    <Box w="100%" bg="lid.bgMed" m="0" pt="0px">
      <Flex maxW="1200px" align="center" ml="auto" mr="auto"
        ...
        <Link display="inline-block" href="https://dexarb.com/" m="0px" ml="-3px">
          <Image src="/logo.png" alt="Dexarb Logo" w="auto" h="60px" display="inline-block" position="relative" top="-10px"/>
      ...
      */}
        <Link display="inline-block" href="https://lid.sh" m="0px" >
          <Image src="/logo-lid.png" alt="Lid Logo" w="auto" h="20px" display="inline-block" position="relative" top="-3px"/>
